...
// TODO: change 'Inhabitent_Hours' to the name of your plugin
class Inhabitent_Hours extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'inhabitent_hours';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'set business hours for Inhabitent'
			)
		);
